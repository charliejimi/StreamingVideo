//
//  NewHomeMenuVideoModeViewController.m
//  streamingVideo
//
//  Created by opcom on 13/1/23.
...
@interface NewHomeMenuVideoModeViewController ()

@end

@implementation NewHomeMenuVideoModeViewController
