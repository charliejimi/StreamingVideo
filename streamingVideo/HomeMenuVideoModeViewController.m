//
//  HomeMenuVideoModeViewController.m
//  streamingVideo
//
...
@interface HomeMenuVideoModeViewController ()

@end

@implementation HomeMenuVideoModeViewController
...
- (void)viewDidLoad
{
    ...
    NSString *CurrentProfiletitle = [NSString stringWithFormat:@"Current Mode"];
    ...
    NSString *TextFieldForSSIDtitle = [NSString stringWithFormat:@"High Quality"];
